        ...
        {Visi &&
          <div className="z-40 absolute right-1 -top-12 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-800 dark:divide-gray-700">
            <ul className="py-2 text-sm text-gray-700 dark:text-gray-200">
              ...
              {/* ========================= Edit Btn ========================= */}
              <li>
                <Link href={`/admin/editstudent/${id}`} className="block font-medium px-4 py-2 hover:bg-gray-200 dark:hover:bg-gray-600 dark:hover:text-white">Talabani Tahrirlash</Link>
              </li>
            </ul>
          </div>
        }
