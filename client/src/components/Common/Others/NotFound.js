        ...
        <>
            < main className="grid min-h-screen place-items-center bg-transparent px-6 py-12 sm:py-12 lg:px-8" >
                <div className="text-center">
                    ...
                    <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-300 sm:text-5xl">Sahifa topilmadi :(</h1>
                    <p className="mt-6 text-base leading-7 text-gray-600 dark:text-gray-300">Kechirasiz, siz qidirayotgan sahifa topilmadi.</p>
